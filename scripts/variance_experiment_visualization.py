...
LOCAL_CPU_FULL_RESULT_PATH = (
    OUTPUT_DATA_PATH / "full_ptq_baseline_experiment_data_CPU_EXP_2.csv"
)
LOCAL_GPU_FULL_RESULT_PATH = (
    OUTPUT_DATA_PATH / "full_ptq_baseline_experiment_data_local_GPU_EXP_2.csv"
)
...
LOCAL_CPU_WEIGHT_ONLY_RESULT_PATH = (
    OUTPUT_DATA_PATH / "weight_only_ptq_baseline_experiment_data_CPU_EXP_2.csv"
)
LOCAL_GPU_WEIGHT_ONLY_RESULT_PATH = (
    OUTPUT_DATA_PATH / "weight_only_ptq_baseline_experiment_data_local_GPU_EXP_2.csv"
)
...
mae_violin.update_layout(xaxis_tickfont=dict(size=16))
mae_violin.update_annotations(font=dict(size=26))
mae_violin.write_html(OUTPUT_FIGURE_PATH / "relative_MAE_config_device_location_test.html")
...
absolute_median_latency_full = full_df.query(expr="base_metric == 'median_latency' & ~relative")
absolute_median_latency_full["value"] = absolute_median_latency_full["value"] * 1000.0
absolute_latency_violin = px.violin(data_frame=absolute_median_latency_full,
                       x="location",
                       y="value",
                       color="device",
                       color_discrete_sequence=px.colors.qualitative.D3,
...
absolute_latency_violin.write_html(OUTPUT_FIGURE_PATH / "absolute_median_latency_location_device.html")
...
absolute_latency_violin.update_annotations(font=dict(size=26))
absolute_latency_violin.write_html(OUTPUT_FIGURE_PATH / "absolute_median_latency_config_device.html")
...
absolute_latency_violin.update_layout(xaxis_tickfont=dict(size=16))
absolute_latency_violin.update_annotations(font=dict(size=26))
absolute_latency_violin.write_html(OUTPUT_FIGURE_PATH / "absolute_median_latency_config_location.html")

relative_latency_violin = px.violin(data_frame=full_df.query(expr="base_metric == 'median_latency' & relative"),
                       x="config_name",
                       y="value",
                       color="device",
                       color_discrete_sequence=px.colors.qualitative.D3,
...
relative_latency_violin.write_html(OUTPUT_FIGURE_PATH / "relative_median_latency_config_device.html")
...
relative_latency_violin.update_layout(xaxis_tickfont=dict(size=16))
relative_latency_violin.update_annotations(font=dict(size=26))
relative_latency_violin.write_html(OUTPUT_FIGURE_PATH / "relative_median_latency_config_location.html")

relative_latency_violin_weight_only = px.violin(data_frame=weight_df.query(expr="base_metric == 'median_latency' & relative"),
                       x="runtime",
                       y="value",
                       color="precision",
                       color_discrete_sequence=px.colors.qualitative.D3,
...
relative_latency_violin_weight_only.write_html(OUTPUT_FIGURE_PATH / "relative_median_latency_precision_runtime.html")
...
relative_latency_violin_weight_only.update_annotations(font=dict(size=26))
relative_latency_violin_weight_only.write_html(OUTPUT_FIGURE_PATH / "relative_median_latency_precision_runtime_device_location.html")

relative_size_violin = px.violin(data_frame=weight_df.query(expr="base_metric == 'model_size' & relative"),
                       x="runtime",
                       y="value",
                       color="precision",
                       color_discrete_sequence=px.colors.qualitative.D3,
                       ...
                       labels=dict(
                           precision="Data Type",
                           value="Relative File Size",
                           runtime="Runtime"
                       ),
                       box=False,
                       title="Relative Size Variation Between Runtimes")
relative_size_violin.update_layout(
    template=font_size_template,
    margin=dict(l=120)
)
relative_size_violin.update_annotations(font=dict(size=26))
relative_size_violin.write_html(OUTPUT_FIGURE_PATH / "relative_size_precision_runtime.html")
relative_size_df = weight_df.query(expr="base_metric == 'model_size' & relative")
relative_size_summary_df = relative_size_df.groupby(["runtime", "precision"]).agg(func={"value": [np.median, np.std]})
